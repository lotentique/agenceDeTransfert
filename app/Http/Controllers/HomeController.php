...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $dataset->backgroundColor(['lightgray','lightgray','lightgray','skyblue','red','lightgray','lightgray','lightgray','lightgray','lightgray','lightgray','lightgray']);
        ...
        return view('admin',compact('benefice','stats','statsPA','statsPMA','sommeCaiss','sommeRetrai','capital','gain'))->with($params);
