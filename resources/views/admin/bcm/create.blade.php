...
<div class="NL">
    <div class="panel panel-default" style="background-color:none;border:none;">
        <div class="panel-heading" style="border-bottom:4px solid black;border-radius: 10px;"><h4 style="font-family: impact"><span class="creU"></span> Créer un compte BCM</h4></div>
        <div class="panel-body">
            <form class="form-horizontal" method="POST" action="{{ route('bcm.store') }}">
                {{ csrf_field() }}
                <div class="gauche">
            ...
            <div class="droite">
                ...
                <input id="type_user" type="hidden"  name="type_user" value="bcm">
                <div class="form-group row">
