...
@section('content')
        ...
        <div class="panel-heading" style="border-bottom:4px solid black;border-radius: 10px;"><h4 style="font-family: impact"><span class="creU"></span> Supprimer L'Agent</h4></div>
        <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('agents.destroy', $user->id) }}">
                        {{ csrf_field() }}
                        {{ method_field('DELETE') }}
